...
namespace Chat_Program.Backend.Security
{
	class SymmetricEncryptionImpl
	{
		...
		public static EncryptedText EncryptAes(byte[] textBytes, byte[] password, byte[] saltBytes)
		{
		...
		public static Tuple<byte[], int> DecryptAes(byte[] textBytes, byte[] password, byte[] saltBytes, byte[] vectorBytes)
		{
